...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	common: {
		...
		homeText: {
			...
			// 主页横幅副标题
			subtitle: [
				"In the quiet of dawn, I awaken",
				"Through misty paths, I wander",
				"Beneath cherry blossoms, I dream",
				"Along forgotten trails, I seek",
				"Within still waters, I reflect",
				"Beyond the shrine gates, I find",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
